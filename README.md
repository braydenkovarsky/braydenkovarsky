...
| **Identity & Admin** | **Active Directory, GPO, AWS IAM, Windows/Linux Server** | **How:** 5+ years of managing 30+ users and deploying OS-wide security policies.<br>**Why:** To implement zero-trust principles and maintain a secure access environment. |
